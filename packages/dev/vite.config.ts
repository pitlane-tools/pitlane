...
export default defineConfig({
    ...
    test: {
        ...
        // @pitlane/crawler is a sibling workspace package: build it before
        // running these suites (`vp run build` in packages/crawler). The
        // fixtures load the plugin through a real Vite config resolve, so a
        // test-only source alias would not cover them.
