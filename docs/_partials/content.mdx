import { Callout, Install, NoBuild, Vite } from "../../.docs/app/components/documentation.tsx";
...
<Install packages={["@pitlane/content"]} dev={["satteri","vite-plugin-satteri"]} />
...
<Install packages={["@pitlane/content","satteri"]} />
