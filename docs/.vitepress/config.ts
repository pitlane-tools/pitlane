...
let guides: DefaultTheme.SidebarItem[] = [
    {
        ...
        items: [
            ...
            { text: "Terminal Applications", link: "/guides/terminal-applications" },
            {
                text: "Embedding Terminal Renderers",
                link: "/guides/embedding-terminal-renderers",
            },
        ],
    },
    {
                ...
                sidebar: [
                    ...guides,
                    {
                        ...
                        items: [
                            ...
                            { text: "@pitlane/tui", link: "/package/tui/index" },
                            { text: "@pitlane/tui/node", link: "/package/tui/node" },
                        ],
                    },
                ],
            }),
    ...
    themeConfig: {
        ...
        sidebar: {
            "/package/": [
                ...
                { text: "@pitlane/tui", link: "/package/tui/" },
                { text: "@pitlane/tui/node", link: "/package/tui/node" },
            ],
            "/guides/": guides,
            "/deploy/": guides,
