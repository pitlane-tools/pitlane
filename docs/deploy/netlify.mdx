...
export const installation = await installAlternatives({ dev: ["@netlify/vite-plugin"] });
...
<Callout kind="info" title="Who serves what in dev">
...
<Callout kind="tip" title="Under the hood">
