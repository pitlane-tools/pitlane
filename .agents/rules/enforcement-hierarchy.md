...
`.agents/templates/PROPOSAL.md` carries a “Policies and decisions checked” section. It makes
checking the existing record part of the path of least resistance, instead of a policy saying
“remember to check policies.” That is a Tier 2 template solution, not a Tier 3 reminder.
