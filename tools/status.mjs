...
const STEPS = {
    defaultBranch: step(
        ...
        "Create a branch, push it, open a draft pull request. If these are only for a proposal, ask permission before creating them.",
        "agent",
    ),
    noPullRequest: step(
        "1",
        ...
        "Push the branch and open a draft pull request. Ask permission first if the pull request is only for a proposal.",
        "agent",
    ),
    noProposal: step(
        "2",
        ...
        "Ask whether the human wants a proposal and wait for permission before writing one. If they declined, proceed from the agreed request and pull-request scope.",
        "agent",
        SKILLS.proposal,
    ),
    draft: step(
